...
const map = rest.get("/maps", async (req, res, ctx) => {
  return res(
    ctx.json([
      {
        id: 1,
...
const markers = rest.get("/markers", async (req, res, ctx) => {
  return res(
    ctx.json([
      {
        id: 139,
...
const mapPreview = rest.get("/map_preview", async (req, res, ctx) => {
  return res(
    ctx.json([
      {
        id: 1,
...
const spotUsers = rest.get("/spotusers", async (req, res, ctx) => {
  return res(ctx.json([]));
});
